...
governance, and which use obsolete API shapes. This is the exact command that produced the numbers
above: `@aicorg/cli@alpha` (0.1.0-alpha.4) reproduces the 52-tool application total.
